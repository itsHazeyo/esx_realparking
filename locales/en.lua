Locales['en'] = {
	...
	["press_to_save"]    = "Press ~INPUT_VEH_HORN~ to store your car",
	["not_your_car"]     = "You have to own the car to store it",
	["need_parking_fee"] = "Press ~INPUT_VEH_HORN~ to pay the parking fees for ~g~$%s~s~",
	["no_parking_fee"]   = "Press ~INPUT_VEH_HORN~ to take out your ~y~%s~s~.",
	["not_enough_money"] = "You don't have enough money",
	["parking_fee"]      = "Parking fees: ~g~$%s/day",
	["pay_success"]      = "You paid parking fee for ~g~$%s~s~ and you can drive the car now",
	["pay_nothing"]      = "You\'ve taken a vehicle out of storage.",
